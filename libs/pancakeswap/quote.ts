...
import smartRouterAbi from "../../abis/pancake/smart-router.json";
import factoryAbi from "../../abis/pancake/swapfactory.json";
import {
...
export async function executeSwap({
  ...
  try {
    ...
    const tokeinInAbi = getAbiByAddress(tokenIn);
